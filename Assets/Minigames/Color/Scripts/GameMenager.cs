...
public class GameMenager : MonoBehaviour
{
    ...
    void SetColors()
    {
        ...
        List<BLOCKCOLOR> tempColorList = new List<BLOCKCOLOR>() {BLOCKCOLOR.COLOR1,BLOCKCOLOR.COLOR2,BLOCKCOLOR.COLOR3,
            BLOCKCOLOR.COLOR4,BLOCKCOLOR.COLOR5,BLOCKCOLOR.COLOR6,BLOCKCOLOR.COLOR7,BLOCKCOLOR.COLOR8
        };
